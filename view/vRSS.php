...
<main>        
    ...
    <article id="articleRss">
        <h3>Este feed es un canal de publicación de release en Github de esta aplicación<strong>
                208DWESProyectoFinal1</strong></h3>
        ...
        <div id="divImagenes">
            ...
            <img src="webroot/media/instruccionesRSS1.png" width="800" height="750" alt="instruccionesRSS1"/>
            <img src="webroot/media/instruccionesRSS2.png" width="800" height="750" alt="instruccionesRSS2"/>
        </div></a>
    </article>
</main>